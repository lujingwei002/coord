...
public:
    ...
    void recvTryRegisterSucc(redis::AsyncClient* client, redis::Reply& reply, uint64_t sessionId, uint64_t userId);
    void recvTryRegisterError(redis::AsyncClient* client, redis::Reply& reply, uint64_t sessionId, uint64_t userId);
    void recvRegisterSucc(redis::AsyncClient* client, redis::Reply& reply, uint64_t sessionId, uint64_t userId);
    void recvRegisterError(redis::AsyncClient* client, redis::Reply& reply, uint64_t sessionId, uint64_t userId);
    void recvUnregisterSucc(redis::AsyncClient* client, redis::Reply& reply, uint64_t sessionId, uint64_t userId);
    void recvUnregisterError(redis::AsyncClient* client, redis::Reply& reply, uint64_t sessionId, uint64_t userId);
    //中断上一个请求
