...
#define CC_CLASS(ClassName) \
    public:\
    static thread_local ::coordx::object_pool<ClassName>* allocator;\
    static void MemTrace();\
    void operator delete(void *ptr);\
    void* operator new(size_t size);\
    virtual ::coordx::Type* GetType();\
    virtual const char* TypeName() const;\
    static ::coordx::Type* _type;\
    static const char* _TypeName;

#define CC_IMPLEMENT(ClassName, FullName) \
    thread_local ::coordx::object_pool<ClassName>* ClassName::allocator = new ::coordx::object_pool<ClassName>(FullName);\
    ...
    ::coordx::Type* ClassName::_type = new ::coordx::Type(FullName);\
    ::coordx::Type* ClassName::GetType()\
    {\
