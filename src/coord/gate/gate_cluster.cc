...
void gate_cluster::recvConnectCacheSucc(redis::AsyncClient* client, const redis::RedisResultRef& reply) {
...
void gate_cluster::recvConnectCacheErr(redis::AsyncClient* client, const redis::RedisResultRef& reply) {
    this->coord->CoreLogDebug("[gate_cluster] recvConnectCacheErr, reply='%s'", reply->String());
}

void gate_cluster::recvCacheScriptLoadSucc(redis::AsyncClient* client, const redis::RedisResultRef& reply, const char* name) {
...
void gate_cluster::recvCacheScriptLoadError(redis::AsyncClient* client, const redis::RedisResultRef& reply) {
    this->coord->CoreLogDebug("[gate_cluster] recvCacheScriptLoadError, reply='%s'", reply->String());
}

void gate_cluster::recvRegisterSucc(redis::AsyncClient* client, const redis::RedisResultRef& reply, uint64_t sessionId, uint64_t userId) {
...
void gate_cluster::recvRegisterError(redis::AsyncClient* client, const redis::RedisResultRef& reply, uint64_t sessionId, uint64_t userId) {
...
void gate_cluster::recvTryRegisterSucc(redis::AsyncClient* client, const redis::RedisResultRef& reply, uint64_t sessionId, uint64_t userId) {
...
void gate_cluster::recvTryRegisterError(redis::AsyncClient* client, const redis::RedisResultRef& reply, uint64_t sessionId, uint64_t userId) {
...
void gate_cluster::recvUnregisterSucc(redis::AsyncClient* client, const redis::RedisResultRef& reply, uint64_t sessionId, uint64_t userId) {
...
void gate_cluster::recvUnregisterError(redis::AsyncClient* client, const redis::RedisResultRef& reply, uint64_t sessionId, uint64_t userId) {
    this->coord->CoreLogDebug("[gate_cluster] recvRegisterError, sessionId=%ld, userId=%ld, reply=%s", sessionId, userId, reply->String());
