...
void login_cluster::recvConnectCacheSucc(redis::AsyncClient* client, const redis::RedisResultRef& reply) {
...
void login_cluster::recvConnectCacheErr(redis::AsyncClient* client, const redis::RedisResultRef& reply) {
    this->coord->CoreLogError("[login_cluster] recvConnectCacheErr, reply='%s'", reply->String());
}

void login_cluster::recvCacheScriptLoadSucc(redis::AsyncClient* client, const redis::RedisResultRef& reply, const char* name) {
...
void login_cluster::recvCacheScriptLoadError(redis::AsyncClient* client, const redis::RedisResultRef& reply) {
