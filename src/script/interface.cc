...
static int tolua_collect_coord__redis__RedisResult (lua_State* tolua_S)
{
 coord::redis::RedisResult* self = (coord::redis::RedisResult*) tolua_tousertype(tolua_S,1,0);
	self->Gc();
	return 0;
}
#endif
...
static void tolua_reg_types (lua_State* tolua_S)
{
 ...
 tolua_usertype(tolua_S,"coordx::RcRef<coord::protobuf::Message>");
...
/* method: AddRef of class  coordx::RcObject */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_RcObject_AddRef00
static int tolua_coord_coordx_RcObject_AddRef00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coordx::RcObject",0,&tolua_err) ||
...
#endif
 {
  coordx::RcObject* self = (coordx::RcObject*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* method: DecRef of class  coordx::RcObject */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_RcObject_DecRef00
static int tolua_coord_coordx_RcObject_DecRef00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Gc of class  coordx::RcObject */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_RcObject_Gc00
static int tolua_coord_coordx_RcObject_Gc00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  coordx::RcObject* self = (coordx::RcObject*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Gc'",NULL);
#endif
  {
   self->Gc();
  }
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'Gc'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: AddRef of class  coordx::RcObject */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_RcObject_AddRef01
static int tolua_coord_coordx_RcObject_AddRef01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coordx::RcObject",0,&tolua_err) ||
 ...
 return 0;
tolua_lerror:
 return tolua_coord_coordx_RcObject_AddRef00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: DecRef of class  coordx::RcObject */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_RcObject_DecRef01
static int tolua_coord_coordx_RcObject_DecRef01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coordx::RcObject",0,&tolua_err) ||
 ...
 return 0;
tolua_lerror:
 return tolua_coord_coordx_RcObject_DecRef00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: Gc of class  coordx::RcObject */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_RcObject_Gc01
static int tolua_coord_coordx_RcObject_Gc01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coordx::RcObject",0,&tolua_err) ||
 ...
 return 0;
tolua_lerror:
 return tolua_coord_coordx_RcObject_Gc00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* function: coordx::path::Exists */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_Exists00
static int tolua_coord_coordx_path_Exists00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   bool tolua_ret = (bool)  coordx::path::Exists(path);
...
/* function: coordx::path::BaseName */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_BaseName00
static int tolua_coord_coordx_path_BaseName00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* function: coordx::path::BaseName */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_BaseName01
static int tolua_coord_coordx_path_BaseName01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
 ...
 else
 {
  ...
  {
   const char* tolua_ret = (const char*)  coordx::path::BaseName(path);
   tolua_pushstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
tolua_lerror:
 return tolua_coord_coordx_path_BaseName00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* function: coordx::path::IsDir */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_IsDir00
static int tolua_coord_coordx_path_IsDir00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   bool tolua_ret = (bool)  coordx::path::IsDir(dir);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
...
/* function: coordx::path::ExtName */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_ExtName00
static int tolua_coord_coordx_path_ExtName00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  std::string path = ((std::string)  tolua_tocppstring(tolua_S,1,0));
  {
   std::string tolua_ret = (std::string)  coordx::path::ExtName(path);
...
/* function: coordx::path::GetCwd */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_GetCwd00
static int tolua_coord_coordx_path_GetCwd00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  char* path = ((char*)  tolua_tostring(tolua_S,1,0));
  {
   int tolua_ret = (int)  coordx::path::GetCwd(path);
...
/* function: coordx::path::GetCwd */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_GetCwd01
static int tolua_coord_coordx_path_GetCwd01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     false
 ...
 else
 {
  lua_State* L =  tolua_S;
  {
return coordx::path::GetCwd(L);
  }
 }
 return 1;
tolua_lerror:
 return tolua_coord_coordx_path_GetCwd00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* function: coordx::path::ListDir */
#ifndef TOLUA_DISABLE_tolua_coord_coordx_path_ListDir00
static int tolua_coord_coordx_path_ListDir00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
static int tolua_coord_coord_Coord_Destory01(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"coord::Coord",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"coordx::RcObject",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 {
  coord::Coord* self = (coord::Coord*)  tolua_tousertype(tolua_S,1,0);
  coordx::RcObject* object = ((coordx::RcObject*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Destory'",NULL);
#endif
  {
...
/* get function: Json of class  coord::Coord */
#ifndef TOLUA_DISABLE_tolua_get_coord__Coord_Json_ptr
static int tolua_get_coord__Coord_Json_ptr(lua_State* tolua_S)
{
  coord::Coord* self = (coord::Coord*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'Json'",NULL);
#endif
  tolua_pushusertype(tolua_S,(void*)self->Json,"coord::json::JsonMgr");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: Json of class  coord::Coord */
#ifndef TOLUA_DISABLE_tolua_set_coord__Coord_Json_ptr
static int tolua_set_coord__Coord_Json_ptr(lua_State* tolua_S)
{
  coord::Coord* self = (coord::Coord*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'Json'",NULL);
  if (!tolua_isusertype(tolua_S,2,"coord::json::JsonMgr",0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->Json = ((coord::json::JsonMgr*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
#endif
  {
   coord::protobuf::MessageRef& tolua_ret = (coord::protobuf::MessageRef&)  self->GetProto(index);
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"coord::protobuf::MessageRef");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: Proto of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_Proto00
static int tolua_coord_coord_IReader_Proto00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coord::IReader",0,&tolua_err) ||
     !tolua_isstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  coord::IReader* self = (coord::IReader*)  tolua_tousertype(tolua_S,1,0);
  const char* name = ((const char*)  tolua_tostring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Proto'",NULL);
#endif
  {
   coord::protobuf::MessageRef& tolua_ret = (coord::protobuf::MessageRef&)  self->Proto(name);
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"coord::protobuf::MessageRef");
  }
 }
 return 1;
...
/* method: String of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_String00
static int tolua_coord_coord_IReader_String00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Len of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_Len00
static int tolua_coord_coord_IReader_Len00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Args of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_Args00
static int tolua_coord_coord_IReader_Args00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: String of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_String01
static int tolua_coord_coord_IReader_String01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coord::IReader",0,&tolua_err) ||
...
return self->String(L);
 ...
 return 1;
tolua_lerror:
 return tolua_coord_coord_IReader_String00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: Unpack of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_Unpack00
static int tolua_coord_coord_IReader_Unpack00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Table of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_Table00
static int tolua_coord_coord_IReader_Table00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Json of class  coord::IReader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_IReader_Json00
static int tolua_coord_coord_IReader_Json00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Proto of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_Proto00
static int tolua_coord_coord_base_reader_Proto00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coord::base_reader",0,&tolua_err) ||
     !tolua_isstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  coord::base_reader* self = (coord::base_reader*)  tolua_tousertype(tolua_S,1,0);
  const char* name = ((const char*)  tolua_tostring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Proto'",NULL);
#endif
...
/* method: String of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_String00
static int tolua_coord_coord_base_reader_String00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const coord::base_reader",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const coord::base_reader* self = (const coord::base_reader*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'String'",NULL);
#endif
  {
...
/* method: Len of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_Len00
static int tolua_coord_coord_base_reader_Len00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Args of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_Args00
static int tolua_coord_coord_base_reader_Args00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: String of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_String01
static int tolua_coord_coord_base_reader_String01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const coord::base_reader",0,&tolua_err) ||
...
return self->String(L);
 ...
 return 1;
tolua_lerror:
 return tolua_coord_coord_base_reader_String00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: Unpack of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_Unpack00
static int tolua_coord_coord_base_reader_Unpack00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Table of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_Table00
static int tolua_coord_coord_base_reader_Table00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Json of class  coord::base_reader */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_reader_Json00
static int tolua_coord_coord_base_reader_Json00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* get function: SessionId of class  coord::base_request */
#ifndef TOLUA_DISABLE_tolua_get_coord__base_request_SessionId
static int tolua_get_coord__base_request_SessionId(lua_State* tolua_S)
{
  coord::base_request* self = (coord::base_request*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: SessionId of class  coord::base_request */
#ifndef TOLUA_DISABLE_tolua_set_coord__base_request_SessionId
static int tolua_set_coord__base_request_SessionId(lua_State* tolua_S)
{
  coord::base_request* self = (coord::base_request*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* get function: __base_reader__ of class  coord::base_request */
#ifndef TOLUA_DISABLE_tolua_get_coord__base_request___base_reader__
static int tolua_get_coord__base_request___base_reader__(lua_State* tolua_S)
{
  coord::base_request* self = (coord::base_request*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable '__base_reader__'",NULL);
#endif
#ifdef __cplusplus
  tolua_pushusertype(tolua_S,(void*)static_cast<coord::base_reader*>(self), "coord::base_reader");
#else
  tolua_pushusertype(tolua_S,(void*)((coord::base_reader*)self), "coord::base_reader");
#endif
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* method: Resolve of class  coord::base_response */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_response_Resolve00
static int tolua_coord_coord_base_response_Resolve00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Reject of class  coord::base_response */
#ifndef TOLUA_DISABLE_tolua_coord_coord_base_response_Reject00
static int tolua_coord_coord_base_response_Reject00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* set function: Code of class  coord::base_response */
#ifndef TOLUA_DISABLE_tolua_set_coord__base_response_Code
static int tolua_set_coord__base_response_Code(lua_State* tolua_S)
{
  coord::base_response* self = (coord::base_response*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* set function: Code of class  coord::base_result */
#ifndef TOLUA_DISABLE_tolua_set_coord__base_result_Code
static int tolua_set_coord__base_result_Code(lua_State* tolua_S)
{
  coord::base_result* self = (coord::base_result*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
...
/* get function: __base_reader__ of class  coord::base_result */
#ifndef TOLUA_DISABLE_tolua_get_coord__base_result___base_reader__
static int tolua_get_coord__base_result___base_reader__(lua_State* tolua_S)
{
  coord::base_result* self = (coord::base_result*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable '__base_reader__'",NULL);
...
static int tolua_coord_coord_internal_response_Proto01(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"coord::internal_response",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"coord::protobuf::MessageRef",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 {
  coord::internal_response* self = (coord::internal_response*)  tolua_tousertype(tolua_S,1,0);
  coord::protobuf::MessageRef* proto = ((coord::protobuf::MessageRef*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Proto'",NULL);
#endif
  {
...
#endif
  {
   coord::protobuf::MessageRef& tolua_ret = (coord::protobuf::MessageRef&)  self->Proto();
   tolua_pushusertype(tolua_S,(void*)&tolua_ret,"coord::protobuf::MessageRef");
  }
 }
 return 1;
...
static int tolua_coord_coord_Object_GetComponent00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"coord::Object",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"coordx::Type",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  coord::Object* self = (coord::Object*)  tolua_tousertype(tolua_S,1,0);
  coordx::Type* type = ((coordx::Type*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
...
/* get function: __coordx of class  coord::http::HttpServer */
#ifndef TOLUA_DISABLE_tolua_get_coord__http__HttpServer___coordx__RcObject__
static int tolua_get_coord__http__HttpServer___coordx__RcObject__(lua_State* tolua_S)
{
  coord::http::HttpServer* self = (coord::http::HttpServer*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable '__coordx'",NULL);
#endif
#ifdef __cplusplus
  tolua_pushusertype(tolua_S,(void*)static_cast<coordx::RcObject*>(self), "coordx::RcObject");
#else
  tolua_pushusertype(tolua_S,(void*)((coordx::RcObject*)self), "coordx::RcObject");
#endif
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
...
#endif
  {
   bool tolua_ret = (bool)  self->Static(path,dir);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
...
#endif
  {
   bool tolua_ret = (bool)  self->StaticFile(path,filePath);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
...
static int tolua_coord_coord_gate_GateSession_Push00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"coord::gate::GateSession",0,&tolua_err) ||
     !tolua_isstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isusertype(tolua_S,3,"coord::protobuf::MessageRef",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,4,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  ...
  coord::protobuf::MessageRef* proto = ((coord::protobuf::MessageRef*)  tolua_tousertype(tolua_S,3,0));
#ifndef TOLUA_RELEASE
...
static int tolua_coord_coord_gate_GatePromise_Using00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"coord::gate::GatePromise",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"coord::base_request",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 ...
 {
  coord::gate::GatePromise* self = (coord::gate::GatePromise*)  tolua_tousertype(tolua_S,1,0);
  coord::base_request* request = ((coord::base_request*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
...
/* method: GetMessage of class  coord::protobuf::Message */
#ifndef TOLUA_DISABLE_tolua_coord_coord_protobuf_Message_GetMessage00
static int tolua_coord_coord_protobuf_Message_GetMessage00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
    coordx::RcRef<coord::protobuf::Message> tolua_ret = (  coordx::RcRef<coord::protobuf::Message>)  self->GetMessage(fieldName);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
...
#endif
  {
    coordx::RcRef<coord::protobuf::RepeatMessage> tolua_ret = (  coordx::RcRef<coord::protobuf::RepeatMessage>)  self->GetRepeat(fieldName);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
...
/* method: NewMessage of class  coord::protobuf::Protobuf */
#ifndef TOLUA_DISABLE_tolua_coord_coord_protobuf_Protobuf_NewMessage00
static int tolua_coord_coord_protobuf_Protobuf_NewMessage00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  const char* name = ((const char*)  tolua_tostring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'NewMessage'",NULL);
#endif
  {
    coordx::RcRef<coord::protobuf::Message> tolua_ret = (  coordx::RcRef<coord::protobuf::Message>)  self->NewMessage(name);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::protobuf::Message");
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'NewMessage'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
#endif
  {
    coordx::RcRef<coord::protobuf::Message> tolua_ret = (  coordx::RcRef<coord::protobuf::Message>)  self->Proto(name);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::protobuf::Message");
...
static int tolua_coord_coord_sql_SQLRows_Proto01(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"coord::sql::SQLRows",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"coordx::RcRef<coord::protobuf::Message>",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
 {
  coord::sql::SQLRows* self = (coord::sql::SQLRows*)  tolua_tousertype(tolua_S,1,0);
   coordx::RcRef<coord::protobuf::Message>* proto = ((  coordx::RcRef<coord::protobuf::Message>*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Proto'",NULL);
#endif
  {
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->SELECT(db);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->AUTH(password);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->DEL(key);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->GET(key);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->SET(key,value);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->SETEX(key,data,len,expire);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->SETEX(key,data,expire);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->HGETALL(key);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->HMSET(key,field,value);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->SADD(key,value);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
#endif
  {
    coordx::RcRef<coord::redis::RedisResult> tolua_ret = (  coordx::RcRef<coord::redis::RedisResult>)  self->SREM(key,value);
   {
#ifdef __cplusplus
    void* tolua_obj = tolua_ret.TakeOwnerShip();
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"coord::redis::RedisResult");
...
/* get function: __coordx of class  coord::redis::RedisPromise */
#ifndef TOLUA_DISABLE_tolua_get_coord__redis__RedisPromise___coordx__RcObject__
static int tolua_get_coord__redis__RedisPromise___coordx__RcObject__(lua_State* tolua_S)
{
...
/* method: Await of class  coord::redis::RedisPromise */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisPromise_Await00
static int tolua_coord_coord_redis_RedisPromise_Await00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  lua_State* L =  tolua_S;
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Await'",NULL);
#endif
  {
return self->Await(L);
  }
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'Await'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: delete of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_delete00
static int tolua_coord_coord_redis_RedisResult_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coord::redis::RedisResult",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: Error of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_Error00
static int tolua_coord_coord_redis_RedisResult_Error00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const coord::redis::RedisResult",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const coord::redis::RedisResult* self = (const coord::redis::RedisResult*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Error'",NULL);
#endif
  {
...
/* method: Array of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_Array00
static int tolua_coord_coord_redis_RedisResult_Array00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ArrayCount of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_ArrayCount00
static int tolua_coord_coord_redis_RedisResult_ArrayCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Empty of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_Empty00
static int tolua_coord_coord_redis_RedisResult_Empty00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Empty of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_Empty01
static int tolua_coord_coord_redis_RedisResult_Empty01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const coord::redis::RedisResult",0,&tolua_err) ||
 ...
 return 1;
tolua_lerror:
 return tolua_coord_coord_redis_RedisResult_Empty00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: String of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_String00
static int tolua_coord_coord_redis_RedisResult_String00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Integer of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_Integer00
static int tolua_coord_coord_redis_RedisResult_Integer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Integer of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_Integer01
static int tolua_coord_coord_redis_RedisResult_Integer01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const coord::redis::RedisResult",0,&tolua_err) ||
 ...
 return 1;
tolua_lerror:
 return tolua_coord_coord_redis_RedisResult_Integer00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: String of class  coord::redis::RedisResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_redis_RedisResult_String01
static int tolua_coord_coord_redis_RedisResult_String01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const coord::redis::RedisResult",0,&tolua_err) ||
 ...
 return 1;
tolua_lerror:
 return tolua_coord_coord_redis_RedisResult_String00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: String of class  coord::cache::CacheResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_cache_CacheResult_String00
static int tolua_coord_coord_cache_CacheResult_String00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coord::cache::CacheResult",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  coord::cache::CacheResult* self = (coord::cache::CacheResult*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'String'",NULL);
#endif
  {
...
/* method: Empty of class  coord::cache::CacheResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_cache_CacheResult_Empty00
static int tolua_coord_coord_cache_CacheResult_Empty00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Error of class  coord::cache::CacheResult */
#ifndef TOLUA_DISABLE_tolua_coord_coord_cache_CacheResult_Error00
static int tolua_coord_coord_cache_CacheResult_Error00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   coord::cluster::Promise* tolua_ret = (coord::cluster::Promise*)  self->Request(node,route,data);
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"coord::cluster::Promise");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
static int tolua_coord_coord_cluster_Cluster_Request01(lua_State* tolua_S)
{
 ...
 if (
     ...
     !tolua_isstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isstring(tolua_S,3,0,&tolua_err) ||
     !tolua_isusertype(tolua_S,4,"coordx::RcRef<coord::protobuf::Message>",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,5,&tolua_err)
 )
  goto tolua_lerror;
 else
 {
  ...
  const char* node = ((const char*)  tolua_tostring(tolua_S,2,0));
  const char* route = ((const char*)  tolua_tostring(tolua_S,3,0));
   coordx::RcRef<coord::protobuf::Message>* proto = ((  coordx::RcRef<coord::protobuf::Message>*)  tolua_tousertype(tolua_S,4,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Request'",NULL);
#endif
  {
   coord::cluster::Promise* tolua_ret = (coord::cluster::Promise*)  self->Request(node,route,*proto);
   tolua_pushusertype(tolua_S,(void*)tolua_ret,"coord::cluster::Promise");
  }
 }
 return 1;
...
/* method: Close of class  coord::managed::ManagedAgent */
#ifndef TOLUA_DISABLE_tolua_coord_coord_managed_ManagedAgent_Close00
static int tolua_coord_coord_managed_ManagedAgent_Close00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"coord::managed::ManagedAgent",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* get function: __pipe of class  coord::managed::ManagedAgent */
#ifndef TOLUA_DISABLE_tolua_get_coord__managed__ManagedAgent___pipe__IPipeAgentHandler__
static int tolua_get_coord__managed__ManagedAgent___pipe__IPipeAgentHandler__(lua_State* tolua_S)
{
  coord::managed::ManagedAgent* self = (coord::managed::ManagedAgent*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable '__pipe'",NULL);
#endif
#ifdef __cplusplus
  tolua_pushusertype(tolua_S,(void*)static_cast<coord::pipe::IPipeAgentHandler*>(self), "coord::pipe::IPipeAgentHandler");
#else
  tolua_pushusertype(tolua_S,(void*)((coord::pipe::IPipeAgentHandler*)self), "coord::pipe::IPipeAgentHandler");
#endif
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
...
/* get function: __coordx of class  coord::worker::Promise */
#ifndef TOLUA_DISABLE_tolua_get_coord__worker__Promise___coordx__RcObject__
static int tolua_get_coord__worker__Promise___coordx__RcObject__(lua_State* tolua_S)
{
...
TOLUA_API int tolua_coord_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  tolua_module(tolua_S,"coordx",0);
  tolua_beginmodule(tolua_S,"coordx");
   tolua_cclass(tolua_S,"RcObject","coordx::RcObject","",NULL);
   tolua_beginmodule(tolua_S,"RcObject");
    tolua_function(tolua_S,"AddRef",tolua_coord_coordx_RcObject_AddRef00);
    tolua_function(tolua_S,"DecRef",tolua_coord_coordx_RcObject_DecRef00);
    tolua_function(tolua_S,"Gc",tolua_coord_coordx_RcObject_Gc00);
    tolua_function(tolua_S,"AddRef",tolua_coord_coordx_RcObject_AddRef01);
    tolua_function(tolua_S,"DecRef",tolua_coord_coordx_RcObject_DecRef01);
    tolua_function(tolua_S,"Gc",tolua_coord_coordx_RcObject_Gc01);
   tolua_endmodule(tolua_S);
   tolua_cclass(tolua_S,"Type","coordx::Type","",NULL);
  ...
  tolua_beginmodule(tolua_S,"coordx");
   ...
   tolua_beginmodule(tolua_S,"path");
    tolua_function(tolua_S,"Exists",tolua_coord_coordx_path_Exists00);
    tolua_function(tolua_S,"BaseName",tolua_coord_coordx_path_BaseName00);
    tolua_function(tolua_S,"BaseName",tolua_coord_coordx_path_BaseName01);
    tolua_function(tolua_S,"IsDir",tolua_coord_coordx_path_IsDir00);
    tolua_function(tolua_S,"ExtName",tolua_coord_coordx_path_ExtName00);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"Coord");
    ...
    tolua_variable(tolua_S,"Json",tolua_get_coord__Coord_Json_ptr,tolua_set_coord__Coord_Json_ptr);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
  ...
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_cclass(tolua_S,"IReader","coord::IReader","",NULL);
   tolua_beginmodule(tolua_S,"IReader");
    tolua_function(tolua_S,"Proto",tolua_coord_coord_IReader_Proto00);
    tolua_function(tolua_S,"String",tolua_coord_coord_IReader_String00);
    tolua_function(tolua_S,"Len",tolua_coord_coord_IReader_Len00);
    tolua_function(tolua_S,"Args",tolua_coord_coord_IReader_Args00);
    tolua_function(tolua_S,"String",tolua_coord_coord_IReader_String01);
    tolua_function(tolua_S,"Unpack",tolua_coord_coord_IReader_Unpack00);
    tolua_function(tolua_S,"Table",tolua_coord_coord_IReader_Table00);
    tolua_function(tolua_S,"Json",tolua_coord_coord_IReader_Json00);
   tolua_endmodule(tolua_S);
   tolua_cclass(tolua_S,"base_reader","coord::base_reader","",NULL);
   tolua_beginmodule(tolua_S,"base_reader");
    tolua_function(tolua_S,"Proto",tolua_coord_coord_base_reader_Proto00);
    tolua_function(tolua_S,"String",tolua_coord_coord_base_reader_String00);
    tolua_function(tolua_S,"Len",tolua_coord_coord_base_reader_Len00);
    tolua_function(tolua_S,"Args",tolua_coord_coord_base_reader_Args00);
    tolua_function(tolua_S,"String",tolua_coord_coord_base_reader_String01);
    tolua_function(tolua_S,"Unpack",tolua_coord_coord_base_reader_Unpack00);
    tolua_function(tolua_S,"Table",tolua_coord_coord_base_reader_Table00);
    tolua_function(tolua_S,"Json",tolua_coord_coord_base_reader_Json00);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_cclass(tolua_S,"base_request","coord::base_request","coordx::RcObject",NULL);
  ...
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_cclass(tolua_S,"base_response","coord::base_response","coordx::RcObject",NULL);
  ...
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_cclass(tolua_S,"base_result","coord::base_result","coordx::RcObject",NULL);
  ...
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_cclass(tolua_S,"Object","coord::Object","coordx::RcObject",NULL);
  ...
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_cclass(tolua_S,"Scene","coord::Scene","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"http");
    ...
    tolua_beginmodule(tolua_S,"HttpServer");
     ...
     tolua_variable(tolua_S,"__coordx__RcObject__",tolua_get_coord__http__HttpServer___coordx__RcObject__,NULL);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"http",0);
   tolua_beginmodule(tolua_S,"http");
    tolua_cclass(tolua_S,"HttpRequest","coord::http::HttpRequest","coord::base_request",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"http",0);
   tolua_beginmodule(tolua_S,"http");
    tolua_cclass(tolua_S,"HttpResponse","coord::http::HttpResponse","coord::base_response",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"http",0);
   tolua_beginmodule(tolua_S,"http");
    tolua_cclass(tolua_S,"HttpRouter","coord::http::HttpRouter","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"http");
    ...
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"HttpAgent","coord::http::HttpAgent","base_agent",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"websocket",0);
   tolua_beginmodule(tolua_S,"websocket");
    tolua_cclass(tolua_S,"Frame","coord::websocket::Frame","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"websocket");
    ...
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"Agent","coord::websocket::Agent","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"net");
    ...
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"TcpListener","coord::net::TcpListener","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"net");
    ...
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"TcpAgent","coord::net::TcpAgent","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"gate",0);
   tolua_beginmodule(tolua_S,"gate");
    tolua_cclass(tolua_S,"GateRequest","coord::gate::GateRequest","coord::base_request",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"gate",0);
   tolua_beginmodule(tolua_S,"gate");
    tolua_cclass(tolua_S,"GateNotify","coord::gate::GateNotify","base_notify",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"gate",0);
   tolua_beginmodule(tolua_S,"gate");
    tolua_cclass(tolua_S,"GatePromise","coord::gate::GatePromise","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"protobuf");
    #ifdef __cplusplus
    tolua_cclass(tolua_S,"Message","coord::protobuf::Message","coordx::RcObject",tolua_collect_coord__protobuf__Message);
    #else
    tolua_cclass(tolua_S,"Message","coord::protobuf::Message","coordx::RcObject",NULL);
    #endif
    tolua_beginmodule(tolua_S,"Message");
     ...
     tolua_function(tolua_S,"GetMessage",tolua_coord_coord_protobuf_Message_GetMessage00);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"protobuf");
    #ifdef __cplusplus
    tolua_cclass(tolua_S,"RepeatMessage","coord::protobuf::RepeatMessage","coordx::RcObject",tolua_collect_coord__protobuf__RepeatMessage);
    #else
    tolua_cclass(tolua_S,"RepeatMessage","coord::protobuf::RepeatMessage","coordx::RcObject",NULL);
    #endif
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"protobuf");
    ...
    tolua_beginmodule(tolua_S,"Protobuf");
     ...
     tolua_function(tolua_S,"NewMessage",tolua_coord_coord_protobuf_Protobuf_NewMessage00);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"coord",0);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"sql",0);
   tolua_beginmodule(tolua_S,"sql");
    tolua_cclass(tolua_S,"SQLResult","coord::sql::SQLResult","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"sql",0);
   tolua_beginmodule(tolua_S,"sql");
    tolua_cclass(tolua_S,"SQLRows","coord::sql::SQLRows","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"redis",0);
   tolua_beginmodule(tolua_S,"redis");
    tolua_cclass(tolua_S,"AsyncClient","coord::redis::AsyncClient","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"redis",0);
   tolua_beginmodule(tolua_S,"redis");
    tolua_cclass(tolua_S,"Client","coord::redis::Client","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"redis");
    ...
    tolua_beginmodule(tolua_S,"RedisPromise");
     tolua_variable(tolua_S,"__coordx__RcObject__",tolua_get_coord__redis__RedisPromise___coordx__RcObject__,NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,"redis");
    #ifdef __cplusplus
    tolua_cclass(tolua_S,"RedisResult","coord::redis::RedisResult","coordx::RcObject",tolua_collect_coord__redis__RedisResult);
    #else
    tolua_cclass(tolua_S,"RedisResult","coord::redis::RedisResult","coordx::RcObject",NULL);
    #endif
    tolua_beginmodule(tolua_S,"RedisResult");
     tolua_function(tolua_S,"delete",tolua_coord_coord_redis_RedisResult_delete00);
     tolua_function(tolua_S,"Error",tolua_coord_coord_redis_RedisResult_Error00);
     tolua_function(tolua_S,"Array",tolua_coord_coord_redis_RedisResult_Array00);
     tolua_function(tolua_S,"ArrayCount",tolua_coord_coord_redis_RedisResult_ArrayCount00);
     tolua_function(tolua_S,"Empty",tolua_coord_coord_redis_RedisResult_Empty00);
     tolua_function(tolua_S,"Empty",tolua_coord_coord_redis_RedisResult_Empty01);
     tolua_function(tolua_S,"String",tolua_coord_coord_redis_RedisResult_String00);
     tolua_function(tolua_S,"Integer",tolua_coord_coord_redis_RedisResult_Integer00);
     tolua_function(tolua_S,"Integer",tolua_coord_coord_redis_RedisResult_Integer01);
     tolua_function(tolua_S,"String",tolua_coord_coord_redis_RedisResult_String01);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"coord",0);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"cache",0);
   tolua_beginmodule(tolua_S,"cache");
    tolua_cclass(tolua_S,"CacheResult","coord::cache::CacheResult","coordx::RcObject",NULL);
    tolua_beginmodule(tolua_S,"CacheResult");
     ...
     tolua_function(tolua_S,"Error",tolua_coord_coord_cache_CacheResult_Error00);
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  tolua_module(tolua_S,"coord",0);
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"cache",0);
   tolua_beginmodule(tolua_S,"cache");
    tolua_cclass(tolua_S,"AsyncClient","coord::cache::AsyncClient","coordx::RcObject",NULL);
    tolua_beginmodule(tolua_S,"AsyncClient");
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"cluster",0);
   tolua_beginmodule(tolua_S,"cluster");
    tolua_cclass(tolua_S,"Request","coord::cluster::Request","coord::base_request",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"cluster",0);
   tolua_beginmodule(tolua_S,"cluster");
    tolua_cclass(tolua_S,"Promise","coord::cluster::Promise","coordx::RcObject",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"cluster",0);
   tolua_beginmodule(tolua_S,"cluster");
    tolua_cclass(tolua_S,"Result","coord::cluster::Result","coord::base_result",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"worker",0);
   tolua_beginmodule(tolua_S,"worker");
    tolua_cclass(tolua_S,"Request","coord::worker::Request","coord::base_request",NULL);
    tolua_beginmodule(tolua_S,"Request");
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"worker",0);
   tolua_beginmodule(tolua_S,"worker");
    tolua_cclass(tolua_S,"Result","coord::worker::Result","coord::base_result",NULL);
    tolua_beginmodule(tolua_S,"Result");
    tolua_endmodule(tolua_S);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"coord");
   tolua_module(tolua_S,"worker",0);
   tolua_beginmodule(tolua_S,"worker");
    tolua_cclass(tolua_S,"Notify","coord::worker::Notify","base_notify",NULL);
  ...
  tolua_beginmodule(tolua_S,"coord");
   ...
   tolua_beginmodule(tolua_S,